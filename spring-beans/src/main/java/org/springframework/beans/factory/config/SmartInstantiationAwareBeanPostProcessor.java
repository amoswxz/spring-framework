 ...
 * internal use within the framework. In general, application-provided post-processors should simply implement the plain
 * {@link BeanPostProcessor} interface or derive from the {@link InstantiationAwareBeanPostProcessorAdapter} class. New
 * methods might be added to this interface even in point releases.
 *
...
public interface SmartInstantiationAwareBeanPostProcessor extends InstantiationAwareBeanPostProcessor {
     ...
     * early - that is, before the target bean instance is fully initialized. The exposed object should be equivalent to
     * the what {@link #postProcessBeforeInitialization} / {@link #postProcessAfterInitialization} would expose
     * otherwise. Note that the object returned by this method will be used as bean reference unless the post-processor
     * returns a different wrapper from said post-process callbacks. In other words: Those post-process callbacks may
     * either eventually expose the same reference or alternatively return the raw bean instance from those subsequent
